...
abstract contract NilCurrencyBase is NilBase {
     ...
     */
    function setCurrencyName(string memory name) public virtual onlyExternal {
        tokenName = name;
    }
     ...
     */
    function mintCurrency(uint256 amount) public virtual onlyExternal {
     ...
     * @param amount The amount of currency to mint.
     */
    function sendCurrency(address to, uint256 currencyId, uint256 amount) public virtual onlyExternal {
